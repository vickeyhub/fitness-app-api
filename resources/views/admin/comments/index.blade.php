        ...
        <div class="ibox">
            <div class="ibox-content table-responsive">
                <table class="table table-striped table-bordered">
                    <thead><tr><th>#</th><th>Comment</th><th>Post</th><th>User</th><th>Created</th><th class="text-right">Action</th></tr></thead>
                    <tbody>
                        @forelse ($comments as $comment)
                            <tr>
                                ...
                                <td class="text-right"><button class="btn btn-xs btn-danger js-delete-comment" data-id="{{ $comment->id }}"><i class="fa fa-trash"></i> Delete</button></td>
                            </tr>
                        @empty
